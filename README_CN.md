...
![记忆管理](./docs/Snipaste_2026-02-06_18-16-43.jpg)
![功能开关](./docs/Snipaste_2026-02-07_13-27-25.jpg)
...
![日志查看器](./docs/Snipaste_2026-02-07_13-32-03.jpg)
...
| **ecs/** | 外部化认知步骤界面。当 AI 需要人工审核时弹出，用户可以审批或拒绝 AI 的操作请求，支持只读回放模式和结构化内容可视化展示。 |
...
启动应用后，首先填写 LLM 配置信息：
![LLM 配置](./docs/Snipaste_2026-02-06_18-13-34.jpg)
